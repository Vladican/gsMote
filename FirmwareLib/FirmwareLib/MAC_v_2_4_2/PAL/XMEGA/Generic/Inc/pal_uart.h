 ...
 *
 * $Id: pal_uart.h 17216 2009-08-14 16:12:59Z sschneid $
 *
...
#define ENABLE_UART_0_RX_INT()   (USARTD0.CTRLA |= USART_RXCINTLVL_gm)

/* Enables the TX interrupt of UART0 */
#define ENABLE_UART_0_TX_INT()   (USARTD0.CTRLA |= USART_TXCINTLVL_gm)

/* Disables the RX interrupt of UART0 */
#define DISABLE_UART_0_RX_INT()  (USARTD0.CTRLA &= ~USART_RXCINTLVL_gm)

/* Disables the TX interrupt of UART0 */
#define DISABLE_UART_0_TX_INT()  (USARTD0.CTRLA &= ~USART_TXCINTLVL_gm)
#endif  /* UART0 */

/* UART1 */
#ifdef UART1
/* Enables the RX interrupt of UART1 */
#define ENABLE_UART_1_RX_INT()   (USARTD1.CTRLA |= USART_RXCINTLVL_gm)

/* Enables the TX interrupt of UART1 */
#define ENABLE_UART_1_TX_INT()   (USARTD1.CTRLA |= USART_TXCINTLVL_gm)

/* Disables the RX interrupt of UART1 */
#define DISABLE_UART_1_RX_INT()  (USARTD1.CTRLA &= ~USART_RXCINTLVL_gm)

/* Disables the TX interrupt of UART1 */
#define DISABLE_UART_1_TX_INT()  (USARTD1.CTRLA &= ~USART_TXCINTLVL_gm)
#endif  /* UART1 */
