 ...
 *
 * $Id: mac_msg_types.h 19576 2009-12-18 10:02:30Z sschneid $
 *
...
typedef struct mlme_beacon_notify_ind_tag
{
     ...
     * payload of the beacon frame received by the MAC sublayer. sdu - The set
     * of octets comprising the beacon payload to be transferred from the
